...
const email = ref('')
const txt_submit = ref('Acessar')
// const eyeType = ref('fa-solid fa-eye')
              ...
              <form class="row g-3 mb-3" @submit.prevent="handleSubmit">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <input v-model="email" type="email" placeholder="Insira aqui seu email cadastrado"
                      class="form-control fs-5" id="email" />
                  </div>
                </div>
                <!-- <div class="col-12">
                                    <div class="form-group">
